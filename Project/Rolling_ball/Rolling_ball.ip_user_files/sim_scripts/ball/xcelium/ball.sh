...
#
# Script generated by Vivado on Sat Jun 15 18:35:42 +0800 2024
...
#
# Usage        : ball.sh
#                ball.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ball.sh [-reset_run]
#                ball.sh [-reset_log]
#                ball.sh [-help]
#
...
#                script (type 'ball.sh -help' for more information).
#
...
# script info
echo -e "ball.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ball.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ball xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ball -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ball_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ball.sh [-reset_log]\n\
Usage: ball.sh [-keep_index]\n\
