...
#
# Script generated by Vivado on Fri Jun 14 17:09:36 +0800 2024
...
#
# Usage        : ball92.sh
#                ball92.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ball92.sh [-reset_run]
#                ball92.sh [-reset_log]
#                ball92.sh [-help]
#
...
# script info
echo -e "ball92.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ball92.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ball92 xil_defaultlib.ball92 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ball92 -key {Behavioral:sim_1:Functional:ball92} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ball92.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ball92.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ball92.sh [-help]\n\
Usage: ball92.sh [-step]\n\
Usage: ball92.sh [-lib_map_path]\n\
Usage: ball92.sh [-reset_run]\n\
Usage: ball92.sh [-reset_log]\n\
Usage: ball92.sh [-keep_index]\n\
Usage: ball92.sh [-noclean_files]\n\n\
