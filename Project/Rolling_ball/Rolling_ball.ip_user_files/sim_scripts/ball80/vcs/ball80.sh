...
#
# Script generated by Vivado on Sat Jun 15 18:46:23 +0800 2024
...
#
# Usage        : ball80.sh
#                ball80.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ball80.sh [-reset_run]
#                ball80.sh [-reset_log]
#                ball80.sh [-help]
#
...
#                script (type 'ball80.sh -help' for more information).
#
...
# script info
echo -e "ball80.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ball80.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ball80 xil_defaultlib.glbl -o ball80_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ball80_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ball80_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ball80_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ball80.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ball80.sh [-help]\n\
Usage: ball80.sh [-step]\n\
Usage: ball80.sh [-lib_map_path]\n\
Usage: ball80.sh [-reset_run]\n\
Usage: ball80.sh [-reset_log]\n\
Usage: ball80.sh [-keep_index]\n\
Usage: ball80.sh [-noclean_files]\n\n\
