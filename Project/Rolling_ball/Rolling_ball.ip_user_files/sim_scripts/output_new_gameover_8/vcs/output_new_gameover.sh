...
#
# Script generated by Vivado on Sun Jun 16 11:41:22 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : output_new_gameover.sh
...
#
# Usage        : output_new_gameover.sh
#                output_new_gameover.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                output_new_gameover.sh [-reset_run]
#                output_new_gameover.sh [-reset_log]
#                output_new_gameover.sh [-help]
#
...
#                script (type 'output_new_gameover.sh -help' for more information).
#
...
# script info
echo -e "output_new_gameover.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./output_new_gameover.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.output_new_gameover xil_defaultlib.glbl -o output_new_gameover_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./output_new_gameover_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key output_new_gameover_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc output_new_gameover_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./output_new_gameover.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: output_new_gameover.sh [-help]\n\
Usage: output_new_gameover.sh [-step]\n\
Usage: output_new_gameover.sh [-lib_map_path]\n\
Usage: output_new_gameover.sh [-reset_run]\n\
Usage: output_new_gameover.sh [-reset_log]\n\
Usage: output_new_gameover.sh [-keep_index]\n\
Usage: output_new_gameover.sh [-noclean_files]\n\n\
