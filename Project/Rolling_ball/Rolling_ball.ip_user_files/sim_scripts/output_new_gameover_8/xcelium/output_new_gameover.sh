...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.output_new_gameover xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.output_new_gameover -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log output_new_gameover_sc.so .tmp_log xcelium_lib waves.shm c.obj)
