...
#                script (type 'ball86.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ball86 xil_defaultlib.glbl -o ball86_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ball86_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ball86_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ball86_simv.daidir vcs_lib c.obj)
