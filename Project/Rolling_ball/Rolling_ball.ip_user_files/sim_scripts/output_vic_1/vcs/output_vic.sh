...
#
# Script generated by Vivado on Sat Jun 15 18:51:11 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : output_vic.sh
...
#
# Usage        : output_vic.sh
#                output_vic.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                output_vic.sh [-reset_run]
#                output_vic.sh [-reset_log]
#                output_vic.sh [-help]
#
...
#                script (type 'output_vic.sh -help' for more information).
#
...
# script info
echo -e "output_vic.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./output_vic.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.output_vic xil_defaultlib.glbl -o output_vic_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./output_vic_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/git_repo/DataDesign_FinalProject/Project/Rolling_ball/Rolling_ball.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key output_vic_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc output_vic_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./output_vic.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: output_vic.sh [-help]\n\
Usage: output_vic.sh [-step]\n\
Usage: output_vic.sh [-lib_map_path]\n\
Usage: output_vic.sh [-reset_run]\n\
Usage: output_vic.sh [-reset_log]\n\
Usage: output_vic.sh [-keep_index]\n\
Usage: output_vic.sh [-noclean_files]\n\n\
