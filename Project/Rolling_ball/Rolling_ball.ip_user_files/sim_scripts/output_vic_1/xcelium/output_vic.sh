...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.output_vic xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.output_vic -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/git_repo/DataDesign_FinalProject/Project/Rolling_ball/Rolling_ball.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log output_vic_sc.so .tmp_log xcelium_lib waves.shm c.obj)
