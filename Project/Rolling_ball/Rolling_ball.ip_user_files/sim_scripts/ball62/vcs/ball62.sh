...
#
# Script generated by Vivado on Sat Jun 15 18:45:44 +0800 2024
...
#
# Usage        : ball62.sh
#                ball62.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ball62.sh [-reset_run]
#                ball62.sh [-reset_log]
#                ball62.sh [-help]
#
...
#                script (type 'ball62.sh -help' for more information).
#
...
# script info
echo -e "ball62.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ball62.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ball62 xil_defaultlib.glbl -o ball62_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ball62_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ball62_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ball62_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ball62.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ball62.sh [-help]\n\
Usage: ball62.sh [-step]\n\
Usage: ball62.sh [-lib_map_path]\n\
Usage: ball62.sh [-reset_run]\n\
Usage: ball62.sh [-reset_log]\n\
Usage: ball62.sh [-keep_index]\n\
Usage: ball62.sh [-noclean_files]\n\n\
