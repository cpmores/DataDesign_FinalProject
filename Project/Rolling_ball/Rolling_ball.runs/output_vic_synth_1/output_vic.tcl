...
synth_design -top output_vic -part xc7k160tffg676-2L -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix output_vic_ output_vic.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ output_vic_stub.v
 lappend ipCachedFiles output_vic_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ output_vic_stub.vhdl
 lappend ipCachedFiles output_vic_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ output_vic_sim_netlist.v
 lappend ipCachedFiles output_vic_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ output_vic_sim_netlist.vhdl
 lappend ipCachedFiles output_vic_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp output_vic.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips output_vic]
 }
...
rename_ref -prefix_all output_vic_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef output_vic.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "output_vic_synth_1_synth_report_utilization_0" "report_utilization -file output_vic_utilization_synth.rpt -pb output_vic_utilization_synth.pb"
...
OPTRACE "output_vic_synth_1" END { }
